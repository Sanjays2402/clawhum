...
const nextConfig = {
  ...
  async rewrites() {
    return [
      ...
      { source: "/api/subprocessors", destination: `${process.env.CLAWHUM_API_URL || "http://127.0.0.1:7451"}/subprocessors` },
      { source: "/api/subprocessors/acknowledgement", destination: `${process.env.CLAWHUM_API_URL || "http://127.0.0.1:7451"}/subprocessors/acknowledgement` },
      { source: "/api/subprocessors/subscriptions", destination: `${process.env.CLAWHUM_API_URL || "http://127.0.0.1:7451"}/subprocessors/subscriptions` },
      { source: "/api/subprocessors/subscriptions/:id", destination: `${process.env.CLAWHUM_API_URL || "http://127.0.0.1:7451"}/subprocessors/subscriptions/:id` },
      { source: "/api/subprocessors/:id", destination: `${process.env.CLAWHUM_API_URL || "http://127.0.0.1:7451"}/subprocessors/:id` },
      ...
      { source: "/api/match-topk", destination: `${process.env.CLAWHUM_API_URL || "http://127.0.0.1:7451"}/match-topk` },
